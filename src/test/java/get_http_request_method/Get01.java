...
public class Get01 {
    ...
    In Gherkin Language we use some key words: Given, When, Then, And
    Given: It declares pre-requisites
    When: It is used to declare actions
    Then: It is for outputs
    And: It is used for multiple Given, When, and Then
     */
...
// How to print status code, status Line, content type, ect. on the console
